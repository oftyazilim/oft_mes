import{en as d,eo as K,ep as X,be as v,d as $,L as T,dL as z,dQ as q}from"./main-Cc9Orlpg.js";import{e as u,d as G}from"./ui.errors-BfAujpM4.js";const Ft=u.on,E=u.one,Wt=u.off,kt=u.trigger;u.Event;const Y=u.triggerHandler;/*!
 * devextreme-vue
 * Version: 25.1.5
 ...
 */function x(t,e){for(const n in t)if(t[n]===e)return n;return e}function Q(t){return t[0].toUpperCase()+t.substr(1)}function J(t){return t[0].toLowerCase()+t.substr(1)}function V(t){return J(t.split("-").map(e=>Q(e)).join(""))}function m(t){return t instanceof Date?t.getTime():t}function P(t,e){return m(t)===m(e)?!0:Array.isArray(t)&&Array.isArray(e)?t.length===0&&e.length===0:!1}function Z(t,e){Array.prototype.slice.call(t.childNodes).forEach(e)}function tt(t,e){const n=Object.keys(t);if(n.length!==Object.keys(e).length)return!1;for(const s of n)if(!e.hasOwnProperty(s))return!1;return!0}function et(t,e){let n=t;return e.split(".").forEach(s=>{var o;const i=D(s);n&&(n=i.isCollection?(o=n[i.name])==null?void 0:o[i.index]:n[i.name])}),n}function D(t){const e=t.split("[");return e.length===1?{isCollection:!1,name:t,fullName:t}:{isCollection:!0,name:e[0],fullName:t,index:Number(e[1].slice(0,-1))}}/*!
 * devextreme-vue
 * Version: 25.1.5
 * Build date: Wed Sep 03 2025
 *
 ...
 *
 * https://github.com/DevExpress/devextreme-vue
 */const p="modelValue";function y(t){if(!gt(t)||!t.$_config)return[];const e=t.$.subTree&&t.$.subTree.children;return Array.isArray(e)?e.filter(n=>{if(!h(n))return n}):[]}function st(t){return F(t)}function w(t){const e={};for(const n in t)t.hasOwnProperty(n)&&(e[V(n)]=t[n]);return e}function it(t){var e;return(e=t.children)!=null&&e.default?L(t.children.default()):[]}function M(t){if(!(!t.children||t.children==="object"||!t.children.default))return ht(t.children.default())?t.children.default:void 0}function ot(t){return M(t)}function j(t){return t.$slots}function rt(t){const e=j(t);return e.default?e.default():[]}function at(t,e,n){const s=K(t);return s.provide("eventBus",e.eventBus),ft(s,e),s.mount(n)}function N(t){const e=t.$.vnode.props||{};return w(e)}function I(t){return t.$?t.$.vnode:t}function ct(t){return t.$.vnode.type}function lt(t){return t[p]}function pt(t){const e=`update:${p}`;t.model.prop=p,t.model.event=e,t.props.modelValue={},t.emits={...t.emits,[`${e}`]:null}}function ut(t,e){for(const n in e)!t.hasOwnProperty(n)&&e.hasOwnProperty(n)&&(t[n]=e[n])}function ft(t,e){t._context.components=Object.assign(e.$.appContext.components,t._context.components),Object.setPrototypeOf(t._context.provides,Object.getPrototypeOf(e.$.provides)),Object.assign(t._context.provides,e.$.appContext.provides),t._context.config=e.$.appContext.config,t._context.directives=e.$.appContext.directives,t._context.mixins=e.$.appContext.mixins,ut(t._context.app,e.$.appContext.app)}function L(t){return t.filter(e=>{if(h(e))return L(e.children||[]);const n=e.type;if(n&&typeof n=="object"&&n.$_optionName)return delete e.$_config,delete e.$_innerChanges,e})}function ht(t){let e=!1;return t.forEach(n=>{!mt(n)&&!h(n)&&!dt(n)&&(e=!0)}),e}function dt(t){return t.type===X||t.type.toString()==="Symbol()"&&!t.children}function mt(t){return t.type&&typeof t.type=="object"&&t.type.$_optionName}function F(t){return t.type}function gt(t){return t.$.vnode&&t.$.vnode.children&&t.$.vnode.children.default}/*!
 * devextreme-vue
 * Version: 25.1.5
 * Build date: Wed Sep 03 2025
 *
 ...
 *
 * https://github.com/DevExpress/devextreme-vue
 */function Bt(t){t.extends=jt(),t.model&&pt(t)}function Ut(t){t.extends=Et()}export{Ut as a,Ft as b,E as c,Y as d,Wt as o,Bt as p,kt as t};
