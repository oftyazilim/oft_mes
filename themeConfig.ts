...
let savedLayout:
  | (typeof AppContentLayoutNav)[keyof typeof AppContentLayoutNav]
  | null = null;
if (typeof window !== "undefined") {
  const stored = localStorage.getItem("menuLayout");
  if (
    stored &&
    Object.values(AppContentLayoutNav).includes(
      stored as (typeof AppContentLayoutNav)[keyof typeof AppContentLayoutNav]
    )
  ) {
    savedLayout =
      stored as (typeof AppContentLayoutNav)[keyof typeof AppContentLayoutNav];
