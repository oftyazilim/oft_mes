...
export const emailValidator = (value: unknown) => {
  ...
  if (Array.isArray(value))
    return value.every(val => re.test(String(val))) || 'E-posta alanı geçerli bir e-posta olmalıdır'

  return re.test(String(value)) || 'E-posta alanı geçerli bir e-posta olmalıdır'
}
